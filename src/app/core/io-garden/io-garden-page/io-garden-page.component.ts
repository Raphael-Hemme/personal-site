...
export class IoGardenPageComponent implements OnInit {
  ...
  public ioAbstract = `Io-Garden is a space for growing and experimenting with ideas and concepts, algorithms and impressions. Freshly planted seeds and seedlings, as well as shrubs, trees and vines can evolve and flourish und the special greenhouse construction that shields this digital garden from Io's atmosphere. Io-Garden is my extraterrestrial research lab and open atelier.`;

  public ioNameExplainer = `Ok, Io-Garden is a laboratory greenhouse on Io.\n
    But why build it on Io you might ask. Well, born on (or in?) Europa, I felt Io was underrated and a welcome change. Property was and is affordable and, having figured out a way to utilize the strong electro magnetic interference, I was able to significantly lower my energy costs.\n
